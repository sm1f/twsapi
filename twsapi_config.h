...
#define TWSAPI_VERSION "0.6.0"

/* the version number: 1.2.3 value is 10203 */
#define TWSAPI_VERSION_NUMBER 600

/* IB's original version string like "1.2.3" */
#define TWSAPI_IB_VERSION "9.71"

/* IB's original version number: 1.2.3 value is 10203 */
#define TWSAPI_IB_VERSION_NUMBER 971

/* IB's CLIENT_VERSION (protocol version) */
#define TWSAPI_IB_CLIENT_VERSION 63
